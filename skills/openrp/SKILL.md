...
4. **Character Studio** (6 tools): `openrp_list_characters`, `openrp_list_character_groups`, `openrp_get_character`, `openrp_create_character`, `openrp_update_character`, `openrp_delete_character`
...
## 2. Complete 41 MCP Tools Reference Guide
