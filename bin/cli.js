...
function runList() {
  printBanner();
  console.log('OpenRP Toolkit Catalog (41 MCP Tools & Documentation)\n');
  ...
  const tools = [
    ...
    { cat: '4. Character Studio', items: ['openrp_list_characters', 'openrp_list_character_groups', 'openrp_get_character', 'openrp_create_character', 'openrp_update_character', 'openrp_delete_character'] },
