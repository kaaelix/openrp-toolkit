...
[![OpenRP Suite](https://img.shields.io/badge/OpenRP-v1.1.6-00E5FF?style=for-the-badge&logo=openai&logoColor=white)](https://openrp.ai)
...
[![npm version](https://img.shields.io/badge/npm-v1.1.6-CB3837?style=for-the-badge&logo=npm&logoColor=white)](https://www.npmjs.com/package/openrp-toolkit)
...
> [!NOTE]
> **Community Release Notice (v1.1.6)**:
> Version `1.1.6` introduces Dynamic User, World & Chat Session Discovery, Universal Auto-Sync for Skills across all AI agent platforms (`openrp-toolkit sync` / `install.sh`), Zero-Quota Local 1-Click Release Engine, and AI-Customizable Dynamic Narrative Prompts.
