...
* **43 Comprehensive MCP Tools**: Full operational coverage across 9 distinct domains (Auth, Worlds, Lorebooks, Characters, Character Groups, Prompts, Behaviors, Executions, Chats, and AI Foundation Models).
